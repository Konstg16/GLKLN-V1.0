...
#define STRING_CONFIG_H_AUTHOR "Konstantin Goulitski" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GLKLN_v1.0"
...
#define HOTEND_OFFSET_Y {0.0, 17.50}  // (in mm) for each extruder, offset of the hotend on the Y axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 396.82, 94}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION Y_MAX_POS - MIN_PROBE_EDGE - Y_PROBE_OFFSET_FROM_EXTRUDER
  
  //#define LEFT_PROBE_BED_POSITION MIN_PROBE_EDGE + 5
  //#define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE) - 5
